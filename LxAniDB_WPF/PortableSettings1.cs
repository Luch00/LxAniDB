...
public class PortableSettingsProvider : SettingsProvider
{
    ...
    public override string ApplicationName
    {
        get
        {
            if (Application.ResourceAssembly.GetName().Name.Trim().Length > 0)
            {
    ...
    public virtual string GetAppSettingsPath()
    {
        ...
        return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"Luch\LXAniDB");
    }
